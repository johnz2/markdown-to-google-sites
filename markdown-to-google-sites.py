...
def markdown_to_google_sites(input_filename, print_markdown_html=False,
    ...
    markdown_to_gsites_notice = "<!-- This HTML was autogenerated by markdown-to-google-sites.py -->\n\n"
    
    def script_print(print_string, verbose=False, is_html_output=False, show_banner=True):
